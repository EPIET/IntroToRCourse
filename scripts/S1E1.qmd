...
**Action** — Now it's time to create your first object `disease` which contains the character "salmonella". Try out and then call the object to see the difference <!--# this asks for object assignment before it is explained (in Part 3). I wouldn't use this excercise here unless you explain it in presentation. -->
...
# You can simply call your new object, now that's stored in your enviroment:
disease
```

...
1.  You must have realized that it takes more time and effort to check the result of this grouped operation. The dataset has 2627 rows and only has 4 years, so it takes a while to navigate. We can do better.

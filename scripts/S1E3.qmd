...
*"Get familiar with it"*, she said. Before any analysis, before any cleaning, before any conclusions: you need to know what you are working with. That is what this exercise is about.
...
This means your dataframe `imd_raw` is is a single object that contains multiple vectors. To extract a single column from a dataframe, use the `$` operator like this:
...
opts_vector <- c(
  ...
  answer = "A sequence of values of the same or different type — equivalent to a single column in a dataframe",

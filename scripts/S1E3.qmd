...
*"Get familiar with it"*, she said. Before any analysis, before any cleaning, before any conclusions: you need to know what you are working with. That is what this exercise is about. If you haven't done it yet, go to the data set page to learn about the data you will be using through this course. <!--# what do you mean with data set page?  -->
